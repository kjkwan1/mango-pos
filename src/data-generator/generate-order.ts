...
export function generateOrderItem(depth = 0): OrderItem {
    ...
    return {
        ...
        category: faker.helpers.arrayElement(['Food', 'Beverage', 'Snacks', 'Kids', 'Menu', 'A la carte']),
        subcategory: faker.helpers.arrayElement(['subcategory1', 'subcategory4', 'subcategory4', 'subcategory4']),
